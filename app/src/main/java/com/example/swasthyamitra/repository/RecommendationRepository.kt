 ...
 */
// Reads AI-generated meal recommendations from Firestore; supports both real-time Flow and one-shot fetch
class RecommendationRepository {
    
    private val db = FirebaseFirestore.getInstance("renu") // Using RENU database instance
    private val auth = FirebaseAuth.getInstance()          // used to scope queries to the current user
     ...
     */
    // Updates a recommendation's status ("Accepted"/"Dismissed") so Cloud Functions can learn user preferences
     ...
     */
    // Marks recommendation as accepted — user liked the suggestion
     ...
     */
    // Marks recommendation as dismissed — user ignored the suggestion
