...
exports.onFoodLogCreated = void 0;
 ...
 */
exports.onFoodLogCreated = functions.firestore
    ...
    try {
        ...
        functions.logger.info(`User ${userId}: ${totalCalories}/${targetCalories} cals consumed, ` +
        ...
        if (remainingCalories > 400 && currentHour >= 18) {
            const dinnerSuggestions = getDinnerSuggestions(remainingCalories, preference, allergies);
 ...
 */
function getDinnerSuggestions(remainingCalories, preference, allergies) {
    const vegOptions = [
 ...
 */
function getHighProteinSuggestions(preference, allergies) {
    const vegOptions = [
